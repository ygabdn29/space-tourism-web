...
function Crew() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 mt-9 lg:mt-20 md:mt-0 lg:ml-[10.5rem] lg:mr-[5.625rem]">
      ...
      <div className="flex mx-6 lg:ml-10 lg:mr-0 md:mx-[10rem] flex-col lg:text-left text-center">
        <h2 className="uppercase font-bellefair text-white opacity-50 text-base lg:text-[2rem] md:text-2xl mb-2 lg:mb-4 md:mb-0">
          {crews[currentCrew].role}
        </h2>

        <h3 className="uppercase font-bellefair text-white text-2xl lg:text-[3.5rem] md:text-[2.5rem] mb-4 lg:mb-7 md:mb-0">
      ...
      <ul className="row-start-4 lg:col-start-1 flex justify-center lg:justify-normal lg:self-auto md:self-center lg:ml-10 lg:mr-0 md:mx-[10rem] gap-4 lg:gap-6 lg:mt-[7.5rem] md:mt-10 mb-8 md:mb-0">
        {crews.map((crew, i) => (
      ...
      <div className="row-start-2 md:row-auto justify-self-center">
        <img
          src={`${crews[currentCrew]["images"]["webp"]}`}
          alt="Photo of crew member"
          className="md:fixed bottom-0 max-h-[14rem] lg:max-h-full md:max-h-[32rem] lg:right-24 md:right-1/2 lg:translate-x-0 md:translate-x-1/2 lg:px-0 md:px-[9rem] md:pt-10 lg:pt-0"
        />
      </div>
